...
const variantClasses: Record<ButtonVariant, string> = {
  primary: "bg-emerald-400 text-emerald-950 hover:bg-emerald-300 pressed:bg-emerald-500",
  secondary: "bg-slate-100 text-slate-900 hover:bg-white pressed:bg-slate-200",
  ghost: "border border-white/30 bg-transparent text-white hover:bg-white/10 pressed:bg-white/20",
};
